...
SELECT * FROM bmsce.book;
SELECT * FROM bmsce.book_authors;
SELECT * FROM bmsce.book_copies;
SELECT * FROM bmsce.book_lending;
SELECT * FROM bmsce.card;
SELECT * FROM bmsce.library_branch;
SELECT * FROM bmsce.publisher;
